...
botao_executar.pack(side=tk.LEFT, padx=10, pady=10)

# Cria o botão para selecionar o arquivo de parâmetro
botao_parametro = tk.Button(janela, text="Parameter file", command=selecionar_arquivo)
botao_parametro.pack(side=tk.LEFT, padx=10, pady=10)
